...
// solving min ||F.m - d||
// F is a filter convolution matrix containing bank of filters
// m0 = input data


int main(int argc, char **argv) {
    
    std::clog << "Starting program: solving min|| F.m - d ||_2 ; F = convolution operator with bank of filters \n";
	srand ( time(0) ); 
...
// set the data vector
    ...
    varConv2D conv(fil, mod->getHyper(), dat->getHyper(),
